  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('basic:classway:save')" type="primary" @click="addOrUpdateHandle()">
          新增
        </el-button>
        <el-button v-if="isAuth('basic:classway:delete')" type="danger" :disabled="dataListSelections.length <= 0" @click="deleteHandle()">
          批量删除
        </el-button>
      </el-form-item>
    </el-form>
    ...
    >
      ...
      >
        <template slot-scope="scope">
          ...
          <el-tag v-if="scope.row.type === 2" size="small">
            一对多
          </el-tag>
          <el-tag v-if="scope.row.type === 3" size="small">
            多对多
          </el-tag>
          <el-tag v-if="scope.row.type === 4" size="small">
            多对一
          </el-tag>
        </template>
      </el-table-column>

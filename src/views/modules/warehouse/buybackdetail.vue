  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('warehouse:buybackdetail:save')" type="primary" @click="buyBackDetailCreate()">
          新增退货记录
        </el-button>
    ...
    <!-- 弹窗，新增 -->
    <buy-back-detail-create v-if="buyBackDetailCreateVisible" ref="buyBackDetailCreate" @refreshDataList="getDataList" />
  </div>
</template>
